"""
Django settings for growthplug_openshift_poc project.
...
SECRET_KEY = '4t0=fv6a)^*gt!_#5e0b)yy@3$&b2tsmrcqloj^5ki=+j9(ii6'
...
ROOT_URLCONF = 'growthplug_openshift_poc.urls'
...
WSGI_APPLICATION = 'growthplug_openshift_poc.wsgi.application'
